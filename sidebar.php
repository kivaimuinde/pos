<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark position-static">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="products.php" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-shop"></i> <span class="ms-1 d-none d-sm-inline">Products</span></a>
                    </li>
                    <li>
                        <a href="categories.php" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-list"></i> <span class="ms-1 d-none d-sm-inline">Categories</span></a>
                    </li>
                    <li>
                        <a href="#subUsers" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-people"></i> <span class="ms-1 d-none d-sm-inline">Users</span> </a>
                            <ul class="collapse nav flex-column ms-1" id="subUsers" data-bs-parent="#menu">
                            <li class="w-100">
