...
<head>
    ...
    <title>POS: SUSPENDED USERS</title>
...
if(!isset($_SESSION["category"])=="admin"){
    ...
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <div class="row">
                <div class="col-9">
                    <h5 class="text text-center">POS Susepended System Users</h3>
                </div>
                <div class="col-3">
                    <button class="btn-primary"><i class="fas fa-plus"></i> Add User</p>
                </div>
            </div>
            <div id="suspended-users-data"></div>
...
<script>
function SuspendedUsersData() {
  var xhttp = new XMLHttpRequest();
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("suspended-users-data").innerHTML =
      this.responseText;
    }
  };
  xhttp.open("GET", "../../backend/users/suspended.php", true);
  xhttp.send();
}
...
window.onload =SuspendedUsersData;
</script>
</html>